...
from EASTER_ch import load_model
from shap.maskers import Text
from shap import Explainer

import nltk

# 1. 将 StanfordCoreNLP-chinese.properties 拷入 STANFORD_CORE_NLP_PATH
# 2. 进入 STANFORD_CORE_NLP_PATH 目录下
# 3. 执行 "java -Xmx4g -cp "*" edu.stanford.nlp.pipeline.StanfordCoreNLPServer -serverProperties StanfordCoreNLP-chinese.properties -port 9000 -timeout 15000"
class OpinionExtractor:
    ...
    def extract_clause_opinion(self,std_p: float = 0.7):
        '''
        ...
        for data in self.data_list:
            ...
            for clause_words_info in clause_words_info_list:
                ...
                opinion = {'actual_index': clause_opinion[1],
                           'after_implicit': clause_opinion[1],
            ...
            if len(one_text_opinion_list)==0:
                if max_clause_opinion is not None:
                    opinion = {'actual_index': max_clause_opinion[1],
                               'after_implicit': max_clause_opinion[1],
    ...
    def _load_data(self):
        ...
        nlp = pyCoreNLP('http://localhost:9000')
...
def main():
    ...
    # # Load the best model.
    best_model = load_model(f'{target_name}_model', (2, 2, 3), (300, 200, 200), (2, 1, 1), 150, include_text_cnn)
    ...
    opinion_list = extractor.extract_clause_opinion(std_p=0.7)
